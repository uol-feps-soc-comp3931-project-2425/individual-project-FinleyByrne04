...
# Load the raw data into a CSV file
...
# Calculate Two-Way ANOVA without interaction values, print and save
# Source: Adapted from https://www.geeksforgeeks.org/how-to-perform-a-two-way-anova-in-python/
...
# Filter scenes that appear both indoors and outside
...
# Run Two-Way ANOVA with interaction on filtered data, print and save
